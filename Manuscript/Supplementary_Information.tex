...
At 16~Ma, we begin to change the subaerial weathering fluxes in accordance with existing constraints (Fig. \ref{fig:seawater_model}). First, the total Sr flux from Himalayan lithologies continues to linearly increase. Second, we linearly decrease the \SrSr of Himalayan lithologies from 0.720 to 0.712 16--12~Ma, then linearly increase it from 0.712 to 0.750 12--0~Ma. The former \SrSr decrease is intended to represent the exhumation of low \SrSr Outer Lesser Himalaya lithologies, and the latter \SrSr increase is intended to represent the exhumation of higher \SrSr Inner Lesser Himalaya lithologies \citep{Myrow2015a, Colleps2018a}. These Himalayan \SrSr changes are consistent with the scattered \SrSr of pedogenic clays in the Bengal Fan and soil carbonate in Nepal \citep{Derry1996a, Quade1997a}. We do not model the decrease in Himalayan river \SrSr \textless5~Ma, since its timing and magnitude is poorly constrained.
