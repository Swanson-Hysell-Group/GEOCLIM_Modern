...
\begin{abstract}
Steep topography, a tropical climate, and mafic lithologies contribute to efficient chemical weathering and carbon sequestration in the Southeast Asian islands. Ongoing arc-continent collision between the Sunda-Banda arc and Australia has increased the area of subaerially-exposed land in the region since the mid-Miocene. Concurrently, Earth's climate has been cooling, marked with the onset of Northern Hemisphere glaciation 3 million years ago. Here we integrate lithology into a coupled weathering-climate model to assess how the global climate system responds to changes in weatherability associated with paleogeographic changes. We then use paleoshoreline data as boundary conditions to quantify the change in steady-state \pCOtwo associated with the tectonic emergence of the Southeast Asian islands since the mid-Miocene. We find that the modeled decrease in \pCOtwo due to these paleogeographic changes is sufficient to explain the majority of long-term climatic cooling over the Neogene.
\end{abstract}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.60\linewidth]{Figures/shoreline_growth.pdf}
