...
\citet{Zhu2020a} reviewed three climate models (CESM2, CESM1, and CCSM4) more recent than the GFDL CM2.0 experiments, and found that they had equilibrium climate sensitivities (the long-term response of global mean surface temperature to a doubling of \pCOtwo) of 5.3, 4.2, and 3.2\degreesC respectively. Of these three climate models, they found that the equilibrium climate sensitivity of CESM1 (4.2\degreesC) was most in agreement with paleo-\pCOtwo and global mean surface temperature data. The GFDL CM2.0 experiments have a lower equilibrium climate sensitivity ($\sim$2\degreesC) than CESM1. This discrepancy indicates that our \pCOtwo estimates (Fig. \ref{fig:scenario_pCO2_all}) are biased toward higher values than what would have been obtained if we had used CESM1 as the climate model component. However, equilibrium climate sensitivity over the Neogene remains poorly constrained, with estimates ranging from 1.5--4.5\degreesC \citep{Zhu2020a}.
